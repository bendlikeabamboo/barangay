...
This section covers common errors and their solutions when using the barangay package.
...
4. Reuse FuzzBase for batch operations:
...
1. Increase timeout:
   ...
   .. code-block:: python
      ...
      dm = DataManager()
      # DataManager uses default timeout, but you can modify the downloader
