---
title: "Data Models Explained"
description: "Overview of the three barangay PSGC data model shapes: nested (basic), flat (list), and extended (recursive tree). Choose the right model for your use case."
...
- [Data models reference](../reference/python-api/data-models.qmd) — pydantic `AdminDiv` family
- [Data dictionary](../reference/data-dictionary.qmd) — field-by-field reference
- [Database reference](../reference/python-api/database.qmd) — `to_frame()` / `to_dicts()` column list
