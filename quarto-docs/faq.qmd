...
Every record comes from the official PSA PSGC masterlist — no invented values. The currently bundled masterlist is `2026-07-13`. New masterlists are bundled whenever the PSA publishes one, as a calendar-versioned data-update release.
