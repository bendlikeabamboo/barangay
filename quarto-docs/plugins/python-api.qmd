...
```python
{
    "field_group": "psgc_aux_data",       # plugin name
...
- [Plugin configuration](configuration.qmd) — discovery and activation precedence
- [Creating a plugin](creating.qmd) — manifest and data format guide
