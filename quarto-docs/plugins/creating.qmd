...
- [Plugins overview](index.qmd) — scalar vs array shapes, manifest fields
- [Built-in plugins](built-in.qmd) — reference plugins to model yours on
- [Plugin configuration](configuration.qmd) — discovery and activation
