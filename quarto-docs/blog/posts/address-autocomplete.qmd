...
description: "Build a fast Philippine address autocomplete using the barangay package's offline fuzzy search. No API calls, no rate limits — instant suggestions across 42,010 barangays."
...
See the [fuzzy search blog post](fuzzy-search-barangays.qmd) and the
