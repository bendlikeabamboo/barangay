...
- **42,010 barangays** with similar or duplicated names across provinces.
...
result = validate("Tongmageng, Sitangkai, Tawi-Tawi")
...
Read the full [address validation tutorial](../../learn/address-validation.qmd)
or browse the [validation API reference](../../reference/python-api/validation.qmd).
