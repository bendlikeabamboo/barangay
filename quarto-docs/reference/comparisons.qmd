---
title: "barangay vs psgc-api vs raw PSA CSV"
...
| Bundled, queryable dataset | ✅ 42,010 barangays | ✅ | ❌ (parse yourself) |
...
| Historical PSGC versions | ✅ bundled (2022–2026) | ⚠️ varies | ✅ manual |
| CLI included | ✅ | ❌ | ❌ |
...
See the [full documentation](../index.qmd) for installation, tutorials, and the
plugin system.

## See also

- [PSGC overview](../concepts/psgc-overview.qmd) — what the PSGC is and where it comes from
- [Database reference](python-api/database.qmd) — the API behind these capabilities
- [Changelog](../changelog.qmd) — data version history
