---
title: "Versioning (`use_version`, `Database`, `AdminLevel`)"
...
# Enable plugins
barangay.use_plugins(["psgc-aux-data"], levels=[barangay.AdminLevel.HIGHLY_URBANIZED_CITY])
```
...
print(db.all_records)  # <PSGC all database: 43768 records>
```
